...
CREATE TABLE `menus` (
  ...
  `Category` enum('Starter','Course','Drink','Dessert') DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `menuitemid_fk` FOREIGN KEY (`MenuItemID`) REFERENCES `menus` (`MenuItemID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-15  0:36:29
